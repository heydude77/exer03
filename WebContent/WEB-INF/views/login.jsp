	...
	<div align="center">
		<h1>〔로그인〕</h1>
			<%if(request.getAttribute("loginError") !=null) {%>
				<p id="msg"	style="font-size: small; color: red; ">
		...
		<form action="<%=application.getContextPath() %>/session.do" method="post" autocomplete="off" >
			<p>
				<b>ID</b><br/>
				<input type="text" name="id" placeholder="account id" style="width: 99%;" id="id"/>
			</p>
			<p>
				<b>Password</b><br/>	
				<input type="password" name="pass" placeholder="account pass" style="width: 99%;" id="pw"/>
			</p>
			<p>
